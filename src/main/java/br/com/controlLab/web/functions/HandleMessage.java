package br.com.controlLab.web.functions;
...
public class HandleMessage {
	...
	public static FacesMessage validatorError(String detail) {
		return new FacesMessage(FacesMessage.SEVERITY_ERROR, "Erro de validaï¿½ï¿½o:", detail+".");
	}
	
	public static FacesMessage converterError(String detail) {
		return new FacesMessage(FacesMessage.SEVERITY_ERROR, "Erro de conversï¿½o:", detail+".");
	}
}
